package restaurant_data_jpa_api.controller;
...
import restaurant_data_jpa_api.service.RestaurantService;
...
public class RestaurantController {
	...
	@DeleteMapping("/restaurant-data-api/{id}")
	public void deleteRestaurantById(@PathVariable Integer id) {
		restaurantServiceRef.deleteRestaurantById(id);
	}
